  ...
  return (
    <div>
      ...
      <div className="flex gap-12 border-solid border-gray-300  ">
        <Link href="/portfolio/illustrations" className="portfolio_link bg-link_image1 bg-cover ">
          <span className="portfolio-link__title">Illustrations</span>
        </Link>
        <Link href="portfolio/websites" className="portfolio_link bg-link_image2">
          <span className="portfolio-link__title">Websites</span>
        </Link>
        <Link href="portfolio/application" className="portfolio_link bg-link_image3">
